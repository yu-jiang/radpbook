...
% Create textarrow
annotation(figure(1),'textarrow',[0.234811165845649 0.215106732348112],...
    [0.187763713080168 0.244725738396624],'String',{'Disturbance injected'});
annotation(figure(1),'textarrow',[0.399014778325123 0.371100164203612],...
    [0.657227848101265 0.71097046413502],'String',{'Controller updated'});
annotation(figure(1),'textarrow',[0.405582922824302 0.377668308702791],...
    [0.171995780590716 0.22573839662447],'String',{'Controller updated'});
annotation(figure(1),'textarrow',[0.239737274220033 0.220032840722496],...
