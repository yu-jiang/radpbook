%SimuNF_nl.m
%tic
function []=timecourse_NF(x0,i)
para
tf=1.5;
[t1,y1]=ode_yu_NF(0,tf,[-x0(1),-x0(2),0,0,0,0,0,0]',dt);
[t2,y2]=ode_yu_NF(0,tf,[-x0(1),-x0(2),0,0,0,0,0,0]',dt);
[t3,y3]=ode_yu_NF(0,tf,[-x0(1),-x0(2),0,0,0,0,0,0]',dt);
[t4,y4]=ode_yu_NF(0,tf,[-x0(1),-x0(2),0,0,0,0,0,0]',dt);
[t5,y5]=ode_yu_NF(0,tf,[-x0(1),-x0(2),0,0,0,0,0,0]',dt);
